class ApiEndpoints {
  // Configuration pour debug mobile - utilise l'API Docker locale
  static const String baseUrl = "http://10.0.2.2:5001/api"; // 10.0.2.2 = localhost depuis émulateur Android
