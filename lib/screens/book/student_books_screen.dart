  ...
  Future<void> _borrowBook(BookModel book) async {
    try {
      ...
      if (success) {
        ...
        setState(() {
          // Retirer le livre des disponibles (disparaît immédiatement)
        ...
        _showPopup("Échec", "Impossible d'emprunter ce livre",
            isSuccess: false);
      }
    } catch (e) {
  ...
  Future<void> _returnBook(BorrowingModel borrowing) async {
    try {
      ...
      if (success) {
        ...
        _showPopup("Échec", "Impossible de retourner le livre",
            isSuccess: false);
      }
    } catch (e) {
  ...
  List<BookModel> get filteredAvailableBooks {
    return availableBooks.where((book) {
      ...
      final matchesBarcode =
          book.barcode?.toLowerCase().contains(query) ?? false;
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText:
                  'Rechercher par titre, auteur, ISBN, code-barres, cours...',
